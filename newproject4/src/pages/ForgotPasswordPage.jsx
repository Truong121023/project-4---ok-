      ...
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className={`${ui.panel} flex flex-col gap-5`}>
          <div>
            ...
            <p className={ui.copy}>
              Yeu cau ma OTP qua email, sau do nhap ma xac minh va mat khau moi de dat lai tai
              khoan.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <article className={ui.card}>
              ...
              <p className={`${ui.muted} mt-3`}>
                Nhap email de nhan ma xac minh dat lai mat khau.
              </p>
            </article>
            ...
            <article className={ui.card}>
              ...
              <p className={`${ui.muted} mt-3`}>
                Dung OTP vua nhan de tao mat khau moi cho tai khoan.
              </p>
            </article>
          </div>
          ...
          <form className="grid gap-4" onSubmit={handleRequestOtp}>
            ...
            <label className="grid gap-2">
              ...
              <input
                ...
                type="email"
                name="email"
                placeholder="user.anna@teamatcha.local"
                value={form.email}
