      ...
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className={`${ui.panel} flex flex-col gap-5`}>
          <div>
            ...
            <h1 className={ui.bannerTitle}>Create your Tea Matcha account in one minute</h1>
            <p className={ui.copy}>
              Tao tai khoan moi de dat mon, thanh toan, theo doi don hang va nhan uu dai thanh vien.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <article className={`${ui.card} h-full`}>
              ...
              <p className={`${ui.muted} mt-3`}>
                Dien thong tin co ban de tao tai khoan moi.
              </p>
            </article>
            ...
            <article className={`${ui.card} h-full`}>
              ...
              <p className={`${ui.muted} mt-3`}>
                Nhan ma OTP qua email va xac minh tai khoan.
              </p>
            </article>
            ...
            <article className={`${ui.card} h-full`}>
              ...
              <p className={`${ui.muted} mt-3`}>
                Dang nhap de bat dau su dung he thong.
              </p>
            </article>
          </div>
        </div>
        ...
        <form className={`${ui.panel} grid gap-5`} onSubmit={handleSubmit}>
          ...
          <div className="rounded-[1.5rem] border border-matcha-900/10 bg-white/70 px-4 py-4 text-sm leading-7 text-stone-600">
            Sau khi dang ky thanh cong, ban se duoc chuyen sang buoc xac minh OTP.
          </div>
