  ...
  switch (sectionKey) {
    ...
    case "orders":
      return {
        ...
        preparingStaffId: toIdString(entity.preparingStaffId),
        ...
        _originalPreparingStaffId: toIdString(entity.preparingStaffId),
...
export function serializeSectionDraft(sectionKey, draft) {
  switch (sectionKey) {
    ...
    case "orders":
      {
        const payload = {};
        const preparingStaffId = draft.preparingStaffId ? Number(draft.preparingStaffId) : null;
        ...
        if (draft.paymentStatus === "PENDING" && draft.paymentStatus !== draft._originalPaymentStatus) {
          payload.preparingStaffId = null;
          payload.deliveringShipperId = null;
          return payload;
        }

        if (["PREPARING", "READY_FOR_SHIPPER"].includes(draft.status)) {
          payload.preparingStaffId = preparingStaffId;
          payload.deliveringShipperId = null;
          return payload;
        }

        if (draft.status === "OUT_FOR_DELIVERY") {
          if (preparingStaffId !== null || draft.preparingStaffId !== draft._originalPreparingStaffId) {
            payload.preparingStaffId = preparingStaffId;
          }
        ...
        if (draft.preparingStaffId !== draft._originalPreparingStaffId) {
          payload.preparingStaffId = preparingStaffId;
        }
    ...
    case "userLevels":
      return {
        ...
        code: draft.code.trim(),
        name: draft.name.trim(),
        minPaidAmount: Number(draft.minPaidAmount),
        active: fromBooleanString(draft.active),
      };
    case "reviews":
      return {
...
export function buildSectionConfigs({
  ...
  return {
    users: {
      title: "Quan ly user",
      description:
        "Tao, cap nhat va quan ly tai khoan nhan su hoac nguoi dung trong he thong.",
      ...
      fields: [
        ...
        },
        {
          ...
          description: userNeedsWorkingStore
            ? lockWorkingStoreId
              ? "Tai khoan nay se duoc gan co dinh vao cua hang hien tai."
              : "Vai tro hien tai can duoc gan voi mot cua hang."
            : "Vai tro nay khong can gan voi cua hang cu the.",
        },
        {
          name: "enabled",
          label: "Enabled",
    ...
    stores: {
      ...
      description: "Quan ly thong tin chi nhanh, hinh anh, khung gio va ban sac cua cua hang.",
      ...
      fields: [
        { name: "name", label: "Store name", required: true, placeholder: "Tea Matcha ..." },
        {
          name: "slug",
          label: "Slug",
          placeholder: "tea-matcha-nguyen-hue",
        ...
        { name: "address", label: "Address", placeholder: "88 Nguyen Hue" },
        {
          ...
          label: "Contact email",
          type: "email",
          placeholder: "store@teamatcha.vn",
        },
        {
          name: "phoneNumber",
          label: "Phone number",
        ...
        },
        {
          ...
          label: "Store gallery",
          type: "image-gallery",
          description: "Tai len anh cua hang. Anh dau tien se duoc uu tien hien thi.",
          uploadFolder: "stores",
        },
        {
          name: "sections",
    ...
    events: {
      ...
      description: "Quan ly su kien theo tung cua hang, lich dien ra va bo anh di kem.",
      ...
      fields: [
        {
          ...
          description: "Chon cua hang to chuc su kien.",
        },
        ...
        { name: "location", label: "Location", placeholder: "Tea Matcha Nguyen Hue" },
        {
          name: "scheduleText",
          label: "Schedule text",
        ...
        },
        {
          ...
          type: "textarea",
          placeholder: "100, 101",
          description: "Nhap danh sach mon noi bat, cach nhau bang dau phay.",
        },
        {
          name: "imagePaths",
          label: "Event gallery",
          type: "image-gallery",
          description: "Tai len anh su kien. Anh dau tien se duoc uu tien hien thi.",
          uploadFolder: "events",
        },
        {
          name: "sections",
    ...
    categories: {
      ...
      description: "Sap xep nhom mon theo tung cua hang de menu ro rang va de quan ly.",
      ...
      fields: [
        {
          ...
          required: true,
          options: storeOptions,
          description: "Chon cua hang ma danh muc nay thuoc ve.",
        },
        ...
        },
        {
          ...
          type: "image-gallery",
          description: "Tai len anh minh hoa cho danh muc.",
    ...
    dishes: {
      ...
      description:
        "Quan ly mon goc cua thuong hieu, mo ta, gia co ban va noi dung gioi thieu.",
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Dish gallery",
          type: "image-gallery",
          description: "Tai len anh mon an. Anh dau tien se duoc uu tien hien thi.",
          uploadFolder: "dishes",
        },
        {
          name: "sections",
    ...
    storeDishes: {
      ...
      description:
        "Quan ly ton kho, kha dung va gia ban thuc te cua mon tai tung cua hang.",
      ...
      fields: [
        {
          ...
          required: true,
          options: storeOptions,
          description: "Moi mon chi can them mot lan cho moi cua hang.",
        },
        {
          name: "dishId",
          label: "Core dish",
          ...
          required: true,
          options: dishOptions,
          description: "Chon mon muon ban tai cua hang nay.",
        },
        {
          name: "quantity",
          label: "Stock",
    ...
    news: {
      ...
      description:
        "Dang bai tin tuc, bai viet noi bat va noi dung editorial gan voi cua hang.",
      ...
      fields: [
        {
          ...
          label: "Title",
          required: true,
          placeholder: "Tea Matcha Airport Hub opens",
        },
        {
          name: "slug",
          label: "Slug",
        ...
        },
        {
          ...
          type: "textarea",
          required: true,
          placeholder: "Tea Matcha officially opened a new airport-area location...",
        },
        {
          name: "relatedStoreId",
          label: "Related store",
        ...
        },
        {
          ...
          label: "News gallery",
          type: "image-gallery",
          description: "Tai len anh cho bai viet nay.",
          uploadFolder: "news",
        },
        {
          name: "sections",
    ...
    userLevels: {
      ...
      description:
        "Thiet lap cac moc thanh vien theo tung cua hang de tinh cap do cho khach hang.",
      ...
      fields: [
        {
          ...
          required: true,
          options: storeOptions,
          description: "Chon cua hang ap dung cap thanh vien nay.",
        },
        {
          name: "code",
          label: "Level code",
    ...
    orders: {
      ...
      description:
        "Xu ly don hang, trang thai thanh toan, hoa don va lich su quet QR trong cung mot khu vuc.",
    ...
    promotions: {
      ...
      description:
        "Tao ma giam gia va cau hinh dieu kien ap dung cho don hang hoac mon an.",
    ...
    reviews: {
      ...
      description:
        "Xem noi dung danh gia va go bo nhung review can xu ly.",
      ...
      fields: [
        ...
        },
        {
          ...
          description: "Dung de xem nhanh doi tuong duoc danh gia.",
        },
        {
          name: "userId",
          label: "Submitted by",
    ...
    feedbacks: {
      ...
      description:
        "Xem phan hoi tu khach hang, tra loi va xu ly cac truong hop can can thiep.",
