  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="rounded-lg border border-ink-900/10 bg-cream-100/60 px-4 py-3 text-sm leading-7 text-ink-600">
        <p className="font-semibold text-ink-900">Live support</p>
        <p className="mt-1">
          Chat with a Kamatcha team member about your order, delivery, or any other question.
        </p>
      </div>
    </div>
  );
...
export default function SupportChatPage() {
  return (
    <main className={ui.page}>
      <AccountLayout profile={<ChatProfileRail activePage="support" />}>
        <div>
          ...
          <p className="mt-3 text-sm leading-7 text-ink-600">
            Send a message to Kamatcha support. We typically respond within a few hours.
          </p>
        </div>
